...
//  بســمة
//
//  Created by Ghada&Hadeel on 5/9/17.
...
public class BleManagerNew : NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    static private var instance : BleManagerNew {
        return sharedInstance
    }
    
    private static let sharedInstance = BleManagerNew()
     ...
     */
    static func getInstance() -> BleManagerNew {
        return instance
    }
